...
export default class StackTransitioner extends Component {
  ...
  renderHeader() {
    const { renderHeader, history } = this.props;
    ...
    if (renderHeader) {
      ...
      children && children.props.title && (currentTitle = children.props.title);
      previousChildren && previousChildren.props.title && (previousTitle = previousChildren.props.title);

      if (typeof renderHeader === 'function') {
        return renderHeader(this.animation, this.props);
      }
